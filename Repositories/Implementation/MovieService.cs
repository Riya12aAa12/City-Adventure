...
namespace MovieStoreMvc.Repositories.Implementation
{
    public class MovieService : IMovieService
    {
        ...
        public MovieService(DatabaseContext ctx) => this.ctx = ctx;
        ...
        public MovieListVm List(string term="",bool paging=false, int currentPage=0)
        {
            ...
            if (!string.IsNullOrEmpty(term))
            {
                ...
                list = list.Where(a => a.Title.StartsWith(term, StringComparison.OrdinalIgnoreCase)).ToList();
        ...
        IEnumerable IMovieService.GetGenreByPlaceId(int id)
        {
